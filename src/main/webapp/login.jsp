<%-- 
    Document   : login
    Created on : Jun 22, 2025, 12:03:50 AM
    Author     : Lenovo
--%>
                        ...
                        <form action="login" method="post">
                            ...
                            <div class="form-group">
                                <div class="fxt-transformY-50 fxt-transition-delay-2">
                                    <input id="pass" type="${requestScope.check == null ? 'password' : 'text'}" class="form-control" name="password" placeholder="${requestScope.check == null ? 'Password' : 'Enter new password'}" required value="${requestScope.uPass}">
                            ...
                            <div class="fxt-transformY-50 fxt-transition-delay-2" style="display: flex; justify-content: space-between">
                                <div>
                                    <input ${requestScope.reMem == null ? "" : "checked"} id="remember" type="checkbox" name="remember" style="margin-right: 6px; width: 15px; height: 15px">

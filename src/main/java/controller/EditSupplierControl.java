...
public class EditSupplierControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new ServletException("Error updating supplier: " + e.getMessage(), e);
        } finally {
            em.close();
        }

        // Load updated data
        SupplierDAO daoS = new SupplierDAO(em); // Nếu DAO vẫn đang JDBC, bạn có thể bỏ phần này và load danh sách qua JPA nếu cần.
        CategoryDAO daoC = new CategoryDAO(em); // Tương tự
